...
class Movie(models.Model):
    ...
    budjet = models.PositiveSmallIntegerField("Бюджет", default=0, help_text="указывать сумму в долларах")
...
class Rating(models.Model):
    ...
    star = models.ForeignKey(Rating_star, verbose_name="Звезда", on_delete=models.CASCADE)
    movie = models.ForeignKey(Movie,
                              verbose_name="Фильм",
                              on_delete=models.CASCADE,
                              related_name='ratings',  # чтобы можно было обращаться к этой таблице из табл Movie
                              )
